...
def print_backtest_report(title, result):
    print("\n" + "=" * 50)
    print(title)
    print("=" * 50)
...
baseline = run_backtest("BTCUSDT", "15m", 1000, use_trend_filter=False)
filtered = run_backtest("BTCUSDT", "15m", 1000, use_trend_filter=True)

print_backtest_report("BASELINE BACKTEST", baseline)
print_backtest_report("MULTI-TIMEFRAME FILTER BACKTEST", filtered)
